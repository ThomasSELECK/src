...
if __name__ == "__main__":
    ...
    prp = PreprocessingStep4(dt_col = "date", keep_last_train_days = 366)
    ...
    # You don't have to use df = df construction you can use inplace=True instead. like this
    ...
    # Min transformation will not help here as int16 -> Integer (-32768 to 32767) and our grid_df['release'].max() serves for int16 but we have have an idea how to transform other columns in case we will need it
    ...
    grid_df.to_pickle("E:/tmp/kernels/aux_model/" + 'grid_part_1.pkl')
    ...
    # Safe part 2
    grid_df.to_pickle("E:/tmp/kernels/aux_model/" + 'grid_part_2.pkl')
    print('Size:', grid_df.shape)
    ...
    # or just load part_1
    grid_df = pd.read_pickle("E:/tmp/kernels/aux_model/" + 'grid_part_1.pkl')
    ...
    # Safe part 3
    grid_df.to_pickle("E:/tmp/kernels/aux_model/" + 'grid_part_3.pkl')
    print('Size:', grid_df.shape)
    ...
    grid_df = pd.concat([pd.read_pickle("E:/tmp/kernels/aux_model/" + 'grid_part_1.pkl'), pd.read_pickle("E:/tmp/kernels/aux_model/" + 'grid_part_2.pkl').iloc[:,2:], pd.read_pickle("E:/tmp/kernels/aux_model/" + 'grid_part_3.pkl').iloc[:,2:]], axis=1)
